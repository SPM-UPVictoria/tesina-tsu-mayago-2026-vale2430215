...
\subsubsection{Sistemas de Información en el PJETAM para el manejo de datos del personal}
\label{sec:sistemas_informacion}

El Poder Judicial del Estado de Tamaulipas (PJETAM) mantiene una necesidad constante de modernizar y ampliar sus sistemas informáticos para agilizar trámites y garantizar la transparencia; esto se refiere a que es primordial tener infraestructura, software especializado y herramientas de ciberseguridad de alta calidad para el desarrollo de sus sistema informáticos. Para hacer frente a estas necesidades, la institución se apoya en el Tribunal Electrónico, un ecosistema digital que requiere soporte y desarrollo tecnológico continuo.
