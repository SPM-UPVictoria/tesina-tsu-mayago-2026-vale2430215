...
En la Figura \ref{fig:mvc_img} se puede observar un esquema que representa la interacción entre los tres componentes del patrón MVC, mostrando cómo el controlador actúa como intermediario entre el modelo y la vista, facilitando la separación de responsabilidades y promoviendo un diseño más limpio y mantenible.
